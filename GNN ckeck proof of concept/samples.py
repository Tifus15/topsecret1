...
def get_3body_samples():
    """ creates a dictonary of initial position of threebody periodic samples:
        samples: 'yarn', 'googles', 'butterfly', 'fig8', 'v810', 'a15', 'a6', 'R10'
        atributes: 'name', 'M', 'q1', 'q2', 'q3', 'v1', 'v2', 'v3', 'T', 'H'
